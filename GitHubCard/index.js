...
// const axiosPromise = axios.get('https://api.github.com/users/amandaburtness')
// // console.log(axiosPromise) // check Promise is working
// .then((r) => {
...
const githubCard = (obj) => {
  ...
  userProfile.textContent =  'Profile: ' + obj.data.html_url
